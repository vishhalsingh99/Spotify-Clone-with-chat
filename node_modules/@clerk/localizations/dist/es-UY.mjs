...
var esUY = {
  ...
  unstable__errors: {
    ...
    form_identifier_not_found: "No se encontr\xF3 una cuenta con este identificador. Por favor, verific\xE1 e intent\xE1 de nuevo.",
    ...
    not_allowed_access: "No ten\xE9s permiso para acceder a esta p\xE1gina. Por favor, contact\xE1 al soporte si cre\xE9s que esto es un error.",
